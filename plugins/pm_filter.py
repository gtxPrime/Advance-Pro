...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Join @movieszhub or @MoviesHubXtream for requesting movies and series, now it doesn't work in PM. If you want to request admins anything use #request </b>")
...
async def select_language(bot, query):
    ...
    btn = [[
        ...
        InlineKeyboardButton("Telegu", callback_data=f"lang#{userid}#tel")
    ],[
        InlineKeyboardButton("Malyalam", callback_data=f"lang#{userid}#mal")
    ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="No More Pages Availabe",callback_data="pages")]
        )
