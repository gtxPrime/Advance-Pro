...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>From now bot does not work in private chat. Please join @MoviesHubXtream or @movieszhub to request movies or series</b>")
    ...
    if query.data.startswith("file"):
                    ...
                    if IS_VERIFY and not await check_verification(client, query.from_user.id):
                        ...
                        await client.send_cached_media(
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/gtxprime")
                                ]
                                ]
                            )
                        )
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/gtxprime")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
