...
API_HASH = "8eef25dc6c4cbf2f6fafb9dd4ec6d7b5"
# BOT_TOKEN = environ['BOT_TOKEN']
BOT_TOKEN = "2085742606:AAGZRisFIqxbqUK3iIw194Tf9jr_6xGh6uQ"
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001315568432').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
# auth_channel = environ.get('AUTH_CHANNEL')
auth_channel = "-1002025820558"
# auth_grp = environ.get('AUTH_GROUP')
auth_grp = "-1001997565102"
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
# support_chat_id = environ.get('SUPPORT_CHAT_ID')
support_chat_id = "-1001997565102"
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001743984455))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CipherGround')
